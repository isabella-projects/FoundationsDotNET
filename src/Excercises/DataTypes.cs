namespace LearnCSharp.Excercises
{
    ...
    {
        public static void IndexOfMethod(bool execute = false)
        {
            if (!execute)
                return;
        ...
        public static void LastIndexOf(bool execute = false)
        {
            if (!execute)
                return;
            ...
            while (true)
            {
                ...
                // unprocessed message:
                msg = msg.Substring(closingPosition + 1);
            }
        }

        public static void IndexOfAny(bool execute = false)
        {
            if (!execute)
                return;
        ...
        public static void Updating(bool execute = false)
        {
            if (!execute)
                return;
        ...
        public static void ChallengeUpdateData(bool execute = false)
        {
            if (!execute)
                return;
